...
export default function Home() {
  ...
  const statsProps = [
    { title: "Container", value: data.containers, icon: Box, gradient: "from-blue-500 to-cyan-500", href: "/containers" },
    { title: "Images", value: data.images, icon: HardDrive, gradient: "from-purple-500 to-pink-500", href: "/images" },
    { title: "Netzwerke", value: data.networks, icon: Network, gradient: "from-orange-500 to-red-500", href: "/networks" },
    { title: "Stacks", value: data.stacks, icon: Layers, gradient: "from-emerald-500 to-teal-500", href: "/stacks" },
  ];
  ...
  return (
    <div className="flex flex-col gap-8 relative">
      <div className="relative z-10">
        ...
        <p className="text-zinc-500 dark:text-zinc-400 mt-2 text-lg">Willkommen bei deiner futuristischen Docker-Zentrale.</p>
      </div>
